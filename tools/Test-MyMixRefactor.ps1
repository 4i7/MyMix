...
if ($Optimized) {
    ...
    Assert-Contains 'EarTrumpet/DataModel/ProcessWatcherService.cs' 'Interlocked.Exchange(ref _disposed, 1)'
    ...
    Assert-Contains 'EarTrumpet/UI/ViewModels/TemporaryAppItemViewModel.cs' 'Interlocked.Exchange(ref _expired, 1)'
    Assert-Contains 'EarTrumpet/UI/ViewModels/TemporaryAppItemViewModel.cs' 'Interlocked.Exchange(ref _disposed, 1)'
    Assert-Contains 'EarTrumpet/UI/ViewModels/TemporaryAppItemViewModel.cs' 'child.PropertyChanged -= ChildApp_PropertyChanged;'
