...
# Keep this stage deliberately small: remove transform overlap and keep scalable single-handle
# polling while giving each process callback an explicit disposable registration lifetime.
